...
{
    public class ReportingDAL : DbContext 
    {
        public ReportingDAL(DbContextOptions<ReportingDAL> options):base(options)
        {

        }
        public Dbset <ReportingMcV01>Reporting { get; set; }
