...
namespace MyAngularASPdotnetCoreWebApp
{
    public class Startup
    {
        ...
        {
            var conStr = Configuration.GetConnectionString("WFconStr");
            services.AddDbContext<WeatherForecastDbContext>(config => config.UseSqlServer(conStr));
